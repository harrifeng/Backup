...
;; I modify the background clolr from #1B1D1E to #272822 to make it from
;; black to grey
(eval-when-compile
  (require 'color-theme))
...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     (mode-line ((t (:foreground "#F8F8F2" :background "#3366FF"
                                 :box (:line-width 1 :color "#3366FF" :style released-button)))))
     (mode-line-buffer-id ((t (:foreground nil :background "#3366FF" :weight semi-bold))))
     (mode-line-inactive ((t (:foreground "#BCBCBC" :background "#3366FF"
                                          :box (:line-width 1 :color "#232526")))))
     (mode-line-mousable ((t (:foreground "#BCBCBC" :background "#3366FF"))))
     (mode-line-mousable-minor-mode ((t (:foreground "#BCBCBC" :background "#3366FF"))))
     ...
     (highlight ((t (:foreground "#3366FF" :background "#C4BE89"))))
     ...
     (isearch ((t (:foreground "#C4BE89" :background "#FFFF99")))) 
     (isearch-fail ((t (:foreground "#FFFFFF" :background "#3366FF"))))
     (lazy-highlight ((t (:foreground "#465457" :background "#3366FF"))))
     ...
     (mumamo-background-chunk-submode ((t (:background "#222827"))))
     ...
     (show-paren-match-face ((t (:foreground "#3366FF" :background "#FD971F"))))
